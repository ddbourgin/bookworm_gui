    ...
    $(document).ready(function() {
        ...
        getHash = function() {
            ...
            var translateOldCounttypes = function(term) {
                ...
                if (typeof(translations[term]) != "undefined") {
        ...
        firstQuery = function() {
            ...
            document.getElementById("sourceName1").innerHTML = 'This American Life';
            ...
            $(".btn", "#word_phoneme_toggle").filter(function(i, v) {
                return $(v).data("val") === params["word_phoneme_toggle"];
            }).addClass("active");
        ...
        minTime = function() {
            return getDate(params["time_limits"][0]).getTime();
            //	return getDate($("#year-slider").slider("values", 0)).getTime();
        };
        maxTime = function() {
            return getDate(params["time_limits"][1]).getTime();
        ...
        renderChart = function() {
            ...
            if (myt === "ep_number_year") {
                xtype = "linear";
            }
            year_span = _.range(query["search_limits"][0][myt]["$gte"], query["search_limits"][0][myt]["$lte"] + 1);
            ...
            chart = new Highcharts.Chart({
                ...
                exporting: {
                    enabled: false, // disable the chart export button
                    buttons: {
                        contextButton: {
        ...
        showBooks = function(event) {
            ...
            terms = query["search_limits"][0]["word"].join(" ");
            if (query["words_collation"] === "Case_Sensitive") {
                sens = "g";
            } else {
                sens = "gi";
            }
            return $.ajax({
                ...
                success: function(response) {
                    ...
                    while (_k < _len3) {
                        ...
                        tst = tst.replace(reg1, function(str) {
                            return '<font color="green">' + str + '</font>'
                        });
                        tst = tst.replace(reg, function(str) {
                            return '<font color="red">' + str + '</font>'
                        });

                        if (matches && regex) {
                            for (i = 0; i < matches.length; i++) {
                                var reg3 = new RegExp("\\b" + matches[i] + "\\b", this.custom.sens);
                                tst = tst.replace(reg3, function(str) {
                                    return '<font color="red">' + str + '</font>'
                                });
                            }
                        }
                    ...
                    i = 0;
                    _ref = Math.min(1000, dataArray.length);
                    while ((0 <= _ref ? i < _ref : i > _ref)) {
                        $(".book-list ol").append(bookLinks[i]);
                        if (0 <= _ref) {
                            i++;
                        } else {
                            i--;
                    ...
                    function toggleLine(e, me) {
                        ...
                        if (toggled === 'False') {
                            ...
                            result = result.replace(reg1, function(str) {
                                return '<font color="green">' + str + '</font>'
                            });
        ...
        popups = ["#settings", "#permalink", "#about", "#download"];
        popup_imgs = [".permalink-img", ".advanced-img", ".about-img", ".download-img"];
        hidePopups = function() {
